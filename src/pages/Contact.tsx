    ...
    <section id="contact" className="content-container relative flex flex-col">
      <div className="flex-1 flex flex-col">
        ...
        <form
          ...
          className="w-full flex flex-col items-center sm:flex-row mt-4 lg:mt-8 bg-slate-500 rounded-b-lg rounded-tl-lg gap-2 lg:gap-5 p-5 lg:p-10"
        >
          ...
          <div className="flex self-end flex-grow-0 flex-shrink">
